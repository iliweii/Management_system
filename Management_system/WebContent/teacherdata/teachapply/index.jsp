...
<head>
    ...
    <title>申请新授课 | 基本信息管理 | <%=systemName %></title>
    ...
    <script src="../../js/teacherdata.teachapply.main.js"></script>
    ...
    <section class="body">
        <div class="inner">
            ...
            <div class="formbody border border-success rounded shadow px-5 py-5">
                ...
                <p class="text-left form-tip">基本信息管理->申请新授课</p>
                <p class="text-left form-tip">申请新授课：申请后请等待管理员审核</p>
