...
<head>
    ...
    <title>学生成绩管理 | 基本数据管理 | <%=systemName %></title>
    ...
    <script src="../../js/teacherdata.resultmanage.main.js"></script>
    ...
    <section class="body">
        <div class="inner">
            ...
            <div class="formbody border border-success rounded shadow px-5 py-5">
                ...
                <p class="text-left form-tip">基本数据管理->学生成绩管理</p>
                ...
                <div class="form-inline">
                    ...
                    <button class="Searchbtn btn btn-outline-success my-2 my-sm-0" type="submit">查询</button>
                     <button class="Clearbtn btn btn-outline-info my-2 my-sm-0 ml-3" type="submit">清空</button>
                </div>
