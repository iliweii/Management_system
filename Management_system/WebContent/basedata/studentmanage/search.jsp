...
<head>
    ...
    <title>学生信息维护 - 查询结果 | 基本数据管理 | <%=systemName %></title>
    ...
    <script src="../../js/basedata.studentmanage.search.js"></script>
    ...
    <section class="body">
        <div class="inner">
            ...
            <div class="formbody border border-success rounded shadow px-5 py-5">
                ...
                <p class="text-left form-tip">基本数据管理->学生信息维护 查询结果</p>

                <!-- 查询栏 -->
                <div class="form-inline">
                    <input class="Searchtext form-control mr-sm-2" type="search" placeholder="学号、姓名" aria-label="学号、姓名">
