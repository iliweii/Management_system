...
<head>
    ...
    <title>管理员维护 - 查询结果 | 基本数据管理 | <%=systemName %></title>
    ...
    <script src="../../js/basedata.adminmanage.search.js"></script>
    ...
    <section class="body">
        <div class="inner">
            ...
            <div class="formbody border border-success rounded shadow px-5 py-5">
                ...
                <p class="text-left form-tip">基本数据管理->管理员维护 查询结果</p>

                <!-- 查询栏 -->
                <div class="form-inline">
                    <input class="Searchtext form-control mr-sm-2" type="search" placeholder="管理员登录名" aria-label="管理员登录名">
