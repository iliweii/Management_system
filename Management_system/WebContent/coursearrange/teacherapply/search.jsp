...
<head>
    ...
    <title>教师授课安排 - 查询结果 | 课程安排管理 | <%=systemName %></title>
    ...
    <script src="../../js/coursearrage.teacherapply.search.js"></script>
    ...
    <section class="body">
        <div class="inner">
            ...
            <div class="formbody border border-success rounded shadow px-5 py-5">
                ...
                <p class="text-left form-tip">课程安排管理->教师授课安排 查询结果</p>

                <!-- 查询栏 -->
                <div class="form-inline">
                    <input class="Searchtext form-control mr-sm-2" type="search" placeholder="教职工号、课程编号" aria-label="教职工号、课程编号">
                    <button class="Searchbtn btn btn-outline-success my-2 my-sm-0" type="submit">查询</button>
                    <button class="Noallowbtn btn btn-primary my-2 my-sm-0 ml-4" type="submit">全部未通过</button>
                </div>
