...
/**
 * Servlet implementation class TeacherApplyAllowBatchServlet
 */
@WebServlet("/TeacherApplyAllowBatchServlet")
public class TeacherApplyAllowBatchServlet extends HttpServlet {
	 ...
	 */
	public TeacherApplyAllowBatchServlet() {
		super();
	}
