...
/**
 * Servlet implementation class StudentResultSearchServlet
 */
@WebServlet("/StudentResultSearchServlet")
public class StudentResultSearchServlet extends HttpServlet {
	 ...
	 */
	public StudentResultSearchServlet() {
		super();
	}
