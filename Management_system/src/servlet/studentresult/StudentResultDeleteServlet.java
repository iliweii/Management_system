...
/**
 * Servlet implementation class StudentResultDeleteServlet
 */
@WebServlet("/StudentResultDeleteServlet")
public class StudentResultDeleteServlet extends HttpServlet {
	 ...
	 */
	public StudentResultDeleteServlet() {
		super();
	}
