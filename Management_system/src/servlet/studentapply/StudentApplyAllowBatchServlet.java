...
/**
 * Servlet implementation class StudentApplyAllowBatchServlet
 */
@WebServlet("/StudentApplyAllowBatchServlet")
public class StudentApplyAllowBatchServlet extends HttpServlet {
	 ...
	 */
	public StudentApplyAllowBatchServlet() {
		super();
	}
